...
import { getLikedProducts } from "@/service/like.service"; // Импорт функции getLikedProducts
...
export default function LikedProducts() {
  ...
  const getData = async () => {
    try {
      const response = await getLikedProducts(10, 1); // Получаем данные о понравившихся продуктах
